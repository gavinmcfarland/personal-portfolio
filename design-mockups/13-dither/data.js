...
window.DATA = {
  ...
  plates: [
    { id: 'a', name: 'drift',  use: 'Loose, open clumping. The default: reads as an illustration at any size and never competes with type set beside it.' },
    { id: 'b', name: 'shoal',  use: 'Denser, banded. Wants to be wide rather than tall — the clumps line up horizontally and a tall crop looks like a mistake.' },
    { id: 'c', name: 'static', use: 'Fine and even. The quietest field; use it when the plate is decoration and the words beside it are the point.' },
    { id: 'd', name: 'bloom',  use: 'Large clumps with open ground between. The loudest field — one per page, or the sheet starts to look like weather.' },
    { id: 'e', name: 'weave',  use: 'Interference between two grids at close pitch. Reads as woven cloth rather than as noise.' },
    { id: 'f', name: 'burr',   use: 'Coarse, irregular, slightly damaged. The mezzotint of the set — good for anything old.' },
  ],

  decals: [
    { id: 'seal',   name: 'seal',   use: 'A dithered ring. Stamped over a corner or a rule to mark something as approved, current, or simply finished.' },
    ...
    { id: 'blot',   name: 'blot',   use: 'An irregular dithered blob. Deliberately overlaps whatever it is placed on — the one playful device here.' },
