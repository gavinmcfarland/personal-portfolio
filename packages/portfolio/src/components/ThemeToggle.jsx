...
const BASE =
  'flex h-[38px] w-[38px] items-center justify-center rounded-full border border-line bg-transparent text-muted transition-colors duration-200 hover:text-ink';
