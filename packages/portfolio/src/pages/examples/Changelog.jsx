...
export default function Changelog() {
  return (
    <DocShell>
      ...
      <h2 id="releases" className="section-label reveal">
        History
      </h2>
      <div className="indent reveal max-w-measure">
        {RELEASES.map((r) => (
