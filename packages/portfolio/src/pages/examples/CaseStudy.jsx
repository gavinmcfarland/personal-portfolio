  ...
  return (
    <DocShell>
      ...
      <header className="pt-(--sp-8)">
        ...
        <p className="indent wordmark">Plugma</p>
        ...
        {/* Tighter than the standard step — the synopsis belongs to the opening
            block rather than starting a new one. */}
        <h2 className="section-label mt-(--sp-4)">SYNOPSIS</h2>
      ...
      <h2 id="manual" className="section-label reveal">
        Manual
      </h2>
      ...
      <h2 id="description" className="section-label reveal">
        Description
      </h2>
      <div className="indent reveal man-body max-w-measure text-muted">
          <p>
      ...
      <h2 id="commands" className="section-label reveal">
        Commands
      </h2>
      <dl className="indent reveal space-y-(--sp-2)">
        {COMMANDS.map((c) => (
      ...
      <div className="indent reveal usage max-w-measure">
      ...
      <h2 id="rationale" className="section-label reveal">
        Decision log
      </h2>
