...
export function CanvasProvider({
  ...
  const eng = useMemo(() => {
    ...
    /* Tell every embedded document the board's gesture state and settled scale.
       The handler is baked into each document at ingest — see ZOOM_OPTS in
       html-bridge.js, which explains what each is used for. Deduped: identical
       state is not re-posted,
